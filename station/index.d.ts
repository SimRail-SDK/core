...
export class Station<Types extends Station.Types> implements Station.Data<Types["stationCode"]> {
    ...
    public readonly data: Station.Data<Types["stationCode"]>;
    ...
    public readonly difficultyLevel: Station.DifficultyLevel;

    /** Specifies a list of dispatchers currently controlling this station. */
    public readonly dispatchers: Station.Dispatcher.List;

    /** Specifies the unique ID of this station. */
    public readonly id: Station.Identifier;

    /** Specifies images for this station. */
    public readonly images: Station.Images;

    /** Specifies the latitude of this station. */
    public readonly latitude: Station.Latitude;

    /** Specifies the longitude of this station. */
    public readonly longitude: Station.Longitude;

    /** Specifies the name of this station. */
    public readonly name: Station.Name;

    /** Specifies the prefix (localized code) of the station. */
    public readonly prefix: Station.Prefix;
    ...
    public server(): Promise<Station.Server<Types>>;
     ...
     */
    public switchServer<ServerCode extends Types["serverCodes"]>(serverCode: ServerCode): Promise<Station<Omit<Types, "serverCode"> & { serverCode: ServerCode }>>;
...
export namespace Station {
     ...
     * @returns The new `Station` instance.
     */
    export function get<Types extends Station.Types>(config: Config<Types>): Promise<Station<Types>>;
