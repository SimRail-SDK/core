...
export class LiveData<Types extends LiveData.Train.Types> implements LiveData.Data {
     ...
     */
    public readonly available: LiveData.Available;

    /** Specifies live data of a train. */
    public readonly data: LiveData.Data;

    /** Specifies information about the train driver. */
    public readonly driver: LiveData.Driver;

    /** Specifies a live data event emitter. */
    public readonly events: LiveData.Event.Emitter<Types>;

    /** Specifies if the train is in the playable area of the game. */
    public readonly inPlayableArea: LiveData.InPlayableArea;

    /** Specifies when the availability was last checked. */
    public readonly lastAvailableCheck: LiveData.LastAvailableCheck;

    /** Specifies the current global latitude of the train. */
    public readonly latitude: LiveData.Latitude;

    /** Specifies the current global longitude of the train. */
    public readonly longitude: LiveData.Longitude;
    ...
    public readonly signal: LiveData.Signal | undefined;

    /** Specifies the current speed of the train. */
    public readonly speed: LiveData.Speed;

    /** Specifies when the live data was last updated. (Excluding `available`) */
    public readonly timestamp: LiveData.Timestamp;

    /** Specifies the index of the current timetable entry of the train. */
    public readonly timetableIndex: LiveData.TimetableIndex;
    ...
    public autoUpdate: LiveData.AutoUpdate;

    /** Specifies the interval for updating live data in milliseconds. */
    public autoUpdateInterval: LiveData.AutoUpdateInterval;
     ...
     */
    public readonly vehicles: LiveData.Vehicles;
...
export namespace LiveData {
     ...
     * @default 5000
     */
    export const DEFAULT_UPDATE_INTERVAL: AutoUpdateInterval;
     ...
     */
    export function get<Types extends Train.Types>(config: Config<Types>): Promise<LiveData<Types>>;
